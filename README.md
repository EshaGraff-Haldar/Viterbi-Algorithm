simple_examples.ipynb has examples of both the Forward Algorithm and Viterbi Algorithm.

Both are used in Hidden Markov Models, where the Markov Chain is not directly observable, but each state will produce an observable output.
